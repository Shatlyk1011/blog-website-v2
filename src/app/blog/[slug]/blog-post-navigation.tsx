          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            {nextPost && (
              <Link
                ...
                className={cn("group relative overflow-hidden rounded-xl bg-white dark:bg-gray-900 p-6 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-gray-200 dark:border-gray-700 md:text-right", !prevPost && 'col-start-2')}
                onClick={() => {
                  posthog.capture('change-post-btn', {
                    href: `/blog/${nextPost.slug}`,
